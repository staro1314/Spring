...
public class ExchangeConfig {
    ...
    public DirectExchange directExchangeA() {
        return new DirectExchange(RabbitMQConfig.EXCHANGE_A,true,false);
    }

    @Bean
    public DirectExchange directExchangeB() {
        return new DirectExchange(RabbitMQConfig.EXCHANGE_B,true,false);
    }

    @Bean
    public DirectExchange directExchangeC() {
        return new DirectExchange(RabbitMQConfig.EXCHANGE_C,true,false);
    }
}
